...
package com.alfa.exception;

import java.util.Arrays;
import org.springframework.http.HttpStatus;
import com.alfa.dtos.ErrorDto;

/**
 * Custom exception ExceptionNotFound.
 * 
 * @author Daniel Zenil
 *
 */
public class ExceptionNotFound extends HistorialClientesException {
  ...
  public ExceptionNotFound(String code, String message) {
    super(code, HttpStatus.NOT_FOUND.value(), message);
  }

  public ExceptionNotFound(String code, String message, ErrorDto data) {
